            ...
            <div class="row">
                <div class="col-md-12 px-1">
                    <div
                        ...
                        <h5 class="mb-0 position-relative " style="margin-right: 30px">@lang('lang.add_coupon')
                    ...
                    {!! Form::open([
                        'url' => action('CouponController@store'),
                        'method' => 'post',
                        'id' => $quick_add ? 'quick_add_coupon_form' : 'coupon_add_form',
                    ]) !!}
                            ...
                            <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('type', ['fixed' => 'Fixed', 'percentage' => 'Percentage'], false, [
                                            'class' => 'form-control',
                                            'data-live-search' => 'true',
                                        ]) !!}
                                    </div>
                                ...
                                <div class="col-md-3 px-5">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('amount_to_be_purchase', null, [
                                            'class' => 'form-control
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            amount_to_be_purchase  modal-input app()->isLocale("ar") ? text-end : text-start ',
