<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('ExchangeRateController@update', $exchange_rate->id),
            'method' => 'put',
        ...
        <div
            ...
            <h4 class="modal-title px-2 position-relative">@lang('lang.edit_rate')
        ...
        <div
            ...
            <div class="form-group col-md-6 px-5">
                ...
                {!! Form::select('store_id', $stores, $exchange_rate->store_id, [
            ...
            <div class="form-group col-md-6 px-5">
                ...
                {!! Form::text('conversion_rate', rtrim(number_format($exchange_rate->conversion_rate, 8, '.', ''), '0'), [
            ...
            <div class="form-group col-md-6 px-5">
                ...
                {!! Form::date('expiry_date', $exchange_rate->expiry_date, [
                    'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
