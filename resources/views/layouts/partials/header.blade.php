        ...
        <div class="container-fluid px-2">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                <a id="toggle-btn" href="#" class="menu-btn border-0">
                    <img src="{{ asset('front/white-menu.png') }}" alt=""></a></a>
                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item ml-2">
                        <button style="border-radius:8px;width: 35px;height: 35px;"
                            class="btn bg-danger text-white no-print d-flex justify-content-center align-items-center"
                            id="power_off_btn" data-toggle="tooltip" data-title="@lang('lang.shut_down')">
                    ...
                    @endcan
                    <li class="nav-item ml-2"><a style="border-radius:8px;width: 35px;height: 35px;"
                            class="btn bg-white no-print d-flex justify-content-center align-items-center"
                            id="btnFullscreen"><i class="dripicons-expand m-0"></i></a></li>
