        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <li class="side_main_menu_link"><a class="link" href="#product" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-cubes"></i><span>{{ __('lang.product')
                            }}</span><span></a>
                    <ul id="product"
                        ...
                        <li
                            ...
                            <a href="{{ action('ProductClassificationTreeController@index') }}">{{
                                __('lang.product_classification_tree') }}</a>
                        </li>
                        @endcan
                ...
                <li class="side_main_menu_link"><a class="link" href="#manufacturings" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-retweet "></i><span>{{ __('lang.manufacturings')
                            }}</span><span></a>
                    <ul id="manufacturings"
                        ...
                        <li
                            class="@if (request()->segment(1) == 'manufacturers' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('ManufacturingController@create') }}">{{ __('lang.add_new_manufacturing')
                                }}</a>
                        </li>
                        <li
                            class="@if (request()->segment(1) == 'email' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('ManufacturingController@index', ['manufacture']) }}">{{
                                __('lang.under_processing') }}</a>
                        </li>
                        <li
                            class="@if (request()->segment(1) == 'email' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('ManufacturingController@index', ['process']) }}">{{ __('lang.processed')
                                }}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="side_main_menu_link"><a class="link" href="#raw_material" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-industry"></i><span>{{ __('lang.raw_material')
                            }}</span><span></a>
                    <ul id="raw_material"
                        ...
                        <li
                            ...
                            <a href="{{ action('RawMaterialController@create') }}">{{ __('lang.add_new_raw_material')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('RawMaterialController@index') }}">{{ __('lang.view_all_raw_materials')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ConsumptionController@create') }}">{{ __('lang.add_manual_consumption')
                                }}</a>
                        </li>
                        @endcan
                        @can('raw_material_module.consumption.create_and_edit')
                        <li
                            ...
                            <a href="{{ action('ConsumptionController@index') }}">{{
                                __('lang.list_view_the_consumption_of_raw_material') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="/raw-materials/transfer?is_raw_material=1">{{
                                __('lang.all_internal_stock_requests_and_transfers') }}</a>
                        </li>
                        @endcan
                        ...
                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                ...
                                                request()->segment(3) == 'create') active @endif">
                            <a href="/raw-materials/internal-stock-request/create">{{ __('lang.internal_stock_request')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li class="@if (request()->segment(1) == 'raw-materials' &&
                                                ...
                                                request()->segment(3) == 'create') active @endif">
                            <a href="/raw-materials/internal-stock-return/create">{{ __('lang.internal_stock_return')
                                }}</a>
                        </li>
                        @endcan
                ...
                <li class="side_main_menu_link"><a class="link" href="#purchase_order" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-card"></i><span>{{ __('lang.purchase_order')
                            }}</span><span></a>
                    <ul id="purchase_order"
                        ...
                        <li
                            ...
                            <a href="{{ action('PurchaseOrderController@getDraftPurchaseOrder') }}">{{
                                __('lang.draft_purchase_order') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('PurchaseOrderController@create') }}">{{
                                __('lang.create_new_purchase_order') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('PurchaseOrderController@index') }}">{{
                                __('lang.view_all_purchase_orders') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('PurchaseOrderController@getImport') }}">{{
                                __('lang.import_purchase_order') }}</a>
                        </li>
                        @endcan
                        @endif
                    </ul>
                ...
                <li class="side_main_menu_link"><a class="link" href="#stock" aria-expanded="false"
                    ...
                    <ul id="stock" class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                        'add-stock',
                                        'remove-stock',
                                        'transfer',
                        ...
                        <li
                            ...
                            <a href="{{ action('ProductController@getProductStocks') }}">{{ __('lang.product_stocks')
                                }}</a>
                        </li>
                        @endcan
                        @can('stock.add_stock.create_and_edit')
                        ...
                        <li
                            ...
                            <a href="{{ action('AddStockController@index') }}">{{ __('lang.view_all_added_stocks')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('RemoveStockController@index') }}">{{ __('lang.view_all_remove_stock')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('RemoveStockController@getCompensated') }}">{{
                                __('lang.compensated_from_supplier') }}</a>
                        </li>
                        @endcan
                ...
                <li class="side_main_menu_link"><a class="link" href="#quotation_for_customers" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-random"></i><span>{{ __('lang.quotation_for_customers')
                            }}</span><span></a>
                ...
                <li class="side_main_menu_link"><a class="link" href="#sale" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-cart"></i><span>{{ __('lang.sales')
                            }}</span><span></a>
                    <ul id="sale"
                ...
                <li class="side_main_menu_link"><a class="link" href="#return" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-undo"></i><span>{{ __('lang.return') }}</span><span></a>
                    <ul id="return"
                        ...
                        <li
                            ...
                            <a href="{{ action('SellReturnController@index') }}">{{ __('lang.view_all_return_sales')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('PurchaseReturnController@create') }}">{{ __('lang.return_purchase')
                                }}</a>
                        </li>
                        @endcan
                        @can('return.purchase_return.create_and_edit')
                        <li
                            ...
                            <a href="{{ action('PurchaseReturnController@index') }}">{{
                                __('lang.view_all_return_purchase') }}</a>
                        </li>
                        @endcan
                ...
                <li class="side_main_menu_link"><a class="link" href="#expense" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-minus-circle"></i><span>{{ __('lang.expense')
                            }}</span><span></a>
                    <ul id="expense"
                        ...
                        <li
                            ...
                            <a href="{{ action('ExpenseCategoryController@create') }}">{{
                                __('lang.add_expense_category') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ExpenseCategoryController@index') }}">{{
                                __('lang.view_expense_categories') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ExpenseBeneficiaryController@create') }}">{{
                                __('lang.add_expense_beneficiary') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ExpenseBeneficiaryController@index') }}">{{
                                __('lang.view_expense_beneficiaries') }}</a>
                        </li>
                        @endcan
                        @can('expense.expense_beneficiaries.create_and_edit')
                        <li
                ...
                <li class="side_main_menu_link"><a class="link" href="#cash" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-money"></i><span>{{ __('lang.cash') }}</span><span></a>
                    <ul id="cash"
                ...
                <li class="side_main_menu_link"><a class="link" href="#adjustment" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-adjust"></i><span>{{ __('lang.adjustment')
                            }}</span><span></a>
                    <ul id="adjustment" class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                        'cash-in-adjustment',
                                        'cash-out-adjustment',
                        ...
                        <li
                            ...
                            <a href="{{ action('CashInAdjustmentController@create') }}">{{
                                __('lang.add_cash_in_adjustment') }}</a>
                        </li>
                        @endcan
                        @can('adjustment.cash_in_adjustment.view')
                        <li
                            class="@if (request()->segment(1) == 'cash-in-adjustment' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('CashInAdjustmentController@index') }}">{{
                                __('lang.view_cash_in_adjustment') }}</a>
                        </li>
                        @endcan
                        @can('adjustment.cash_in_adjustment.create_and_edit')
                        <li
                            class="@if (request()->segment(1) == 'product-in-adjustment-create' && request()->segment(2) == 'create') active @endif">
                            <a href="{{ action('ProductInAdjustmentsController@create') }}">{{
                                __('lang.add_product_in_adjustment') }}</a>
                        </li>
                        @endcan
                        @can('adjustment.cash_in_adjustment.view')
                        <li
                            class="@if (request()->segment(1) == 'product-in-adjustment-index' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('ProductInAdjustmentsController@index') }}">{{
                                __('lang.view_product_in_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CashOutAdjustmentController@create') }}">{{
                                __('lang.add_cash_out_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CashOutAdjustmentController@index') }}">{{
                                __('lang.view_cash_out_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerBalanceAdjustmentController@create') }}">{{
                                __('lang.add_customer_balance_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerBalanceAdjustmentController@index') }}">{{
                                __('lang.view_customer_balance_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerPointAdjustmentController@create') }}">{{
                                __('lang.add_customer_point_adjustment') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerPointAdjustmentController@index') }}">{{
                                __('lang.view_customer_point_adjustment') }}</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="side_main_menu_link"><a class="link" href="#reports" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-file-text"></i><span>{{ __('lang.reports')
                            }}</span><span></a>
                    <ul id="reports"
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getProfitLoss') }}">{{ __('lang.profit_loss_report')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getDailySalesSummary') }}">{{
                                __('lang.daily_sales_summary') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getExpectedReceivableReport') }}">{{
                                __('lang.expected_receivable_report') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getDiningRoomReport') }}">{{ __('lang.dining_in_sales')
                                }}</a>
                        </li>
                        @endcan
                        @endif
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getSalesPerEmployeeReport') }}">{{
                                __('lang.sales_per_employee') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getMonthlySaleReport') }}">{{
                                __('lang.monthly_sale_and_purchase_report') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getDailyPurchaseReport') }}">{{
                                __('lang.daily_purchase_report') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getPaymentReport') }}">{{ __('lang.payment_report')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getPurchaseReport') }}">{{ __('lang.purchase_report')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getProductQuantityAlertReport') }}">{{
                                __('lang.product_quantity_alert_report') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getCustomerReport') }}">{{ __('lang.customer_report')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('ReportController@getSupplierReport') }}">{{ __('lang.supplier_report')
                                }}</a>
                        </li>
                        @endcan
                ...
                <li class="side_main_menu_link"><a class="link" href="#coupons_and_gift_cards" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-card"></i><span>{{ __('lang.coupons_and_gift_cards')
                            }}</span><span></a>
                ...
                <li class="side_main_menu_link"><a class="link" href="#customer" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-user-group"></i><span>{{ __('lang.customers')
                            }}</span><span></a>
                    <ul id="customer"
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerTypeController@create') }}">{{ __('lang.add_new_customer_type')
                                }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('CustomerTypeController@index') }}">{{ __('lang.view_all_customer_types')
                                }}</a>
                        </li>
                        @endcan
                    </ul>
                ...
                <li class="side_main_menu_link"><a class="link" href="#supplier" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-user-group"></i><span>{{ __('lang.suppliers')
                            }}</span><span></a>
                    <ul id="supplier"
                ...
                <li class="side_main_menu_link"><a class="link" href="#sales_promotion" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-bolt"></i><span>{{ __('lang.sales_promotion')
                            }}</span><span></a>
                    <ul id="sales_promotion"
                        ...
                        <li
                            ...
                            <a href="{{ action('SalesPromotionController@create') }}">{{
                                __('lang.add_new_sales_promotion') }}</a>
                        </li>
                        @endcan
                        @can('sp_module.sales_promotion.view')
                        <li
                            class="@if (request()->segment(1) == 'sales-promotion' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('SalesPromotionController@index') }}">{{
                                __('lang.view_all_sales_promotion') }}</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="side_main_menu_link">
                    ...
                    <ul class="list-unstyled collapse @if (request()->segment(1) == 'hrm' &&
                        ...
                        <li
                            class="@if (request()->segment(2) == 'leave' && empty(request()->segment(3))) active @endif">
                            <a
                ...
                <li class="side_main_menu_link"><a class="link" href="#loyalty_points" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-gift"></i><span>{{ __('lang.loyalty_points')
                            }}</span><span></a>
                    <ul id="loyalty_points"
                        ...
                        <li
                            ...
                            <a href="{{ action('EarningOfPointController@create') }}">{{
                                __('lang.earning_of_point_system') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('EarningOfPointController@index') }}">{{
                                __('lang.list_earning_of_points_system') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('RedemptionOfPointController@create') }}">{{
                                __('lang.redemption_of_point_system') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('RedemptionOfPointController@index') }}">{{
                                __('lang.list_redemption_of_points_system') }}</a>
                        </li>
                        @endcan
                        @can('loyalty_points.earning_of_points.view')
                        <li
                            class="@if (request()->segment(1) == 'earning-of-points' && request()->segment(2) == 'get-list-of-earned-point') active @endif">
                            <a href="{{ action('EarningOfPointController@getListOfEarnedPoint') }}">{{
                                __('lang.list_of_earn_point_by_transactions') }}</a>
                        </li>
                        @endcan
                        @can('loyalty_points.earning_of_points.view')
                        <li
                            class="@if (request()->segment(1) == 'redemption-of-points' && request()->segment(2) == 'get-list-of-redeemed-point') active @endif">
                            <a href="{{ action('RedemptionOfPointController@getListOfRedeemedPoint') }}">{{
                                __('lang.list_of_redeemed_point_by_transactions') }}</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                <li class="side_main_menu_link"><a class="link" href="#money_safe" aria-expanded="false"
                        data-toggle="collapse"> <i class="dripicons-box "></i><span>{{ __('lang.money_safe')
                            }}</span><span></a>
                    <ul id="money_safe"
                ...
                <li class="side_main_menu_link"><a class="link" href="#sms" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-comments-o "></i><span>{{ __('lang.sms')
                            }}</span><span></a>
                    <ul id="sms"
                ...
                <li class="side_main_menu_link"><a class="link" href="#email" aria-expanded="false"
                        data-toggle="collapse"> <i class="fa fa-envelope "></i><span>{{ __('lang.email')
                            }}</span><span></a>
                    <ul id="email"
                ...
                <li class="side_main_menu_link"><a class="link" href="#setting" aria-expanded="false"
                    ...
                    <ul id="setting" class="collapse list-unstyled @if (in_array(request()->segment(1), [
                                    'store',
                                    'store-pos',
                        ...
                        <li
                            ...
                            <a href="{{ action('CategoryController@getSubCategories') }}">{{ __('lang.sub_category')
                                }}</a>
                        </li>
                        @endcan
                        @endif
                        ...
                        <li
                            class="@if (request()->segment(1) == 'brand' && empty(request()->segment(2))) active @endif">
                        ...
                        <li
                            class="@if (request()->segment(1) == 'color' && empty(request()->segment(2))) active @endif">
                            <a href="{{ action('ColorController@index') }}">{{ __('lang.color') }}</a>
                        </li>
                        @endcan
                        @can('product_module.grade.view')
                        <li
                            class="@if (request()->segment(1) == 'grade' && empty(request()->segment(2))) active @endif">
                        ...
                        <li
                            ...
                            <a href="{{ action('SupplierCategoryController@index') }}">{{ __('lang.supplier_category')
                                }}</a>
                        </li>
                        @endcan
                        @if (session('system_mode') == 'restaurant')
                        ...
                        <li
                            class="@if (request()->segment(1) == 'tax' && empty(request()->segment(2)) && request()->type == 'product_tax') active @endif">
                            <a href="{{ action('TaxController@index') }}?type=product_tax">{{ __('lang.product_tax')
                                }}</a>
                        </li>
                        @endcan
                        @can('product_module.tax.view')
                        <li
                            class="@if (request()->segment(1) == 'tax' && empty(request()->segment(2)) && request()->type == 'general_tax') active @endif">
                            <a href="{{ action('TaxController@index') }}?type=general_tax">{{ __('lang.general_tax')
                                }}</a>
                        </li>
                        @endcan
                        @can('settings.store.view')
                        <li
                            class="@if (request()->segment(1) == 'store' && empty(request()->segment(2))) active @endif">
                        ...
                        <li
                            ...
                            <a href="{{ action('TermsAndConditionsController@index') }}?type=invoice">{{
                                __('lang.list_invoice_terms_and_condition') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('TermsAndConditionsController@index') }}?type=quotation">{{
                                __('lang.list_quotation_terms_and_condition') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            ...
                            <a href="{{ action('SettingController@getWeighingScaleSetting') }}">{{
                                __('lang.weighing_scale_setting') }}</a>
                        </li>
                        @endcan
                        @can('settings.general_settings.view')
                        <li
                            class="@if (request()->segment(1) == 'settings' && request()->segment(2) == 'get-general-setting') active @endif">
                            <a href="{{ action('SettingController@getGeneralSetting') }}">{{ __('lang.general_settings')
                                }}</a>
                        </li>
                        @endcan
                ...
                <li
                    class="side_main_menu_link @if (request()->segment(1) == 'tutorials' && empty(request()->segment(2))) active @endif">
