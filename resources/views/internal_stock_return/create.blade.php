...
<section class="forms py-2">
    <div class="container-fluid px-2">
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row">
                    <div class="col-md-12 p-1" style="text-align: right; font-size: 22px; font-weight: bold;">
            ...
            <div class="card-body py-2 px-4">
                <div class="col-sm-12">
                    <button type="submit" name="submit" id="save" value="save"
                        class="btn btn-primary pull-right btn-flat submit">@lang( 'lang.request_a_return'
                        )</button>
