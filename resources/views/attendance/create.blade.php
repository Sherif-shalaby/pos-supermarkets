    ...
    <div class="container-fluid px-2">
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row">
                    <div class="col-md-12 flex_center my-2">
                ...
                <table class="table" id="attendance_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="time" class="form-control time" name="attendances[0][check_in]" required>
                            </td>
                            <td>
                                <input type="time" class="form-control time" name="attendances[0][check_out]" required>
                            </td>
                            <td>
