...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-7 mt-4 px-0">
            <x-collapse body-class="show" button-class="w-100 dash-padding" collapse-id="cash_flow">
                <x-slot name="button">
                    <div
                        class="card-header @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif d-flex align-items-center">
                        <h4>@lang('lang.cash_flow')</h4>
                    </div>
                </x-slot>

                <div class="h-100 line-chart-example">
                    <div class="card-body">
                        @php
                        $color = '#733686';
                        ...
                        <canvas id="cashFlow" data-color="{{ $color }}" data-color_rgba="{{ $color_rgba }}"
                            ...
                            data-label1="@lang('lang.payment_received')"
        ...
        <div class="col-md-5  mt-4 px-0">
            <x-collapse body-class="show" button-class="w-100 dash-padding" collapse-id="date">
                <x-slot name="button">
                    <div
                        class="card-header @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif d-flex justify-content-between align-items-center">
                ...
                <div class=" h-100">
                    <div class="pie-chart mb-2">
                        <canvas id="transactionChart" data-color="{{ $color }}" data-color_rgba="{{ $color_rgba }}"
                            ...
                            data-label2="@lang('lang.revenue')" data-label3="@lang('lang.expense')" width="100"
                            height="95">
                        </canvas>
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-2">
            <x-collapse body-class="show" button-class="w-100 dash-padding" collapse-id="yearly_report">
                <x-slot name="button">
                    <div
                        class="card-header @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif d-flex justify-content-between align-items-center">
    ...
    <div class="col-md-12">
        <div class="card mb-2">
            <x-collapse body-class="show" button-class="w-100 dash-padding" collapse-id="recent_transactions">
                <x-slot name="button">

                    <div
                        class="card-header @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif d-flex justify-content-between align-items-center py-3">
    ...
    <div class="col-md-4">
        <div class="card">
            <x-collapse button-class="w-100 dash-padding" body-class="show" collapse-id="best_seller">
                <x-slot name="button">
                    <div
                        class="card-header @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif d-flex justify-content-between align-items-center py-3">
    ...
    <div class="col-md-4">
        <div class="card">
            <x-collapse collapse-id="qty" body-class="show" button-class="w-100 dash-padding">
                <x-slot name="button">
    ...
    <div class="col-md-4">
        <div class="card">
            <x-collapse collapse-id="price" body-class="show" button-class="w-100 dash-padding">
