            ...
            <div class="card mb-2 p-2 @if (app()->isLocale('ar')) page-title-ar @else page-title-en @endif">
                ...
                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                    <div class="col-md-2">
                        ...
                        key($stores),
                        ['class' => 'form-control ','multiple','data-live-search' => 'true', 'id' =>
                        'store_id']) !!}
    ...
    <div class="d-flex justify-content-between">
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                ...
                <div class="name"><strong style="">@lang('lang.sell_current_stock_value')</strong>
                </div>
        ...
        <div style="width: 9%" class=" px-0">
            <div class="wrapper count-title text-center h-100">
                ...
                <div class="name"><strong style="">@lang('lang.expense')</strong>
                </div>
