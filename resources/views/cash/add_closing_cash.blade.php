<div class="modal-dialog add_closing_cash" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="well">
                    <table class="table">
                        <tr>
                            ...
                            <td>{{ $cash_register->created_at ?
                                \Carbon\Carbon::parse($cash_register->created_at)->format('Y-m-d H:i:s') :
                                now()->format('Y-m-d H:i:s') }}</td>
                        </tr>
                        <tr>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('source_type', __('lang.given_to', ['value' => __('lang.user')]), ['id' =>
                            'source_type_label']) !!} <br>
        ...
        <div class="modal-footer">
            <button type="submit" name="submit" class="btn btn-primary col-12 hide" value="adjustment"
                id="adjust-btn">@lang('lang.adjustment')</button>
            <button type="submit" name="submit" class="btn btn-primary col-6" value="save"
                id="closing-save-btn">@lang('lang.save')</button>
            <button type="button"
                class="btn btn-default col-6 @if ($type == 'logout') close-btn-add-closing-cash @endif" @if ($type
                !='logout' ) data-dismiss="modal" @endif>@lang('lang.close')</button>
        </div>
