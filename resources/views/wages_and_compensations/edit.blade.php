        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="payment_type">@lang('lang.payment_type')</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="other_payment">@lang('lang.other_payment')</label>
                    ...
                    <div class="col-md-4 account_period">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="account_period">@lang('lang.account_period')</label>
                    ...
                    <div
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="locale_label mb-1" for="acount_period_start_date">@lang('lang.acount_period_start_date')</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="locale_label mb-1" for="acount_period_end_date">@lang('lang.acount_period_end_date')</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="deductibles">@lang('lang.deductibles')</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="reasons_of_deductibles">@lang('lang.reasons_of_deductibles')</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="net_amount">@lang('lang.net_amount')</label>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="locale_label mb-1" for="notes">@lang('lang.notes')</label>
