                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="i-checks" style="margin-top: 30px">
                                    ...
                                    id="product_condition" name="product_condition" type="checkbox"
            ...
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="i-checks">
                                <input @if ($sales_promotion->purchase_condition)
                                checked @endif id="purchase_condition" name="purchase_condition" type="checkbox"
                                value="1"
                    ...
                    <div class="col-md-4 mt-5">
                        <div class="form-group">
                            <div class="i-checks">
                                <input value="1" @if ($sales_promotion->generate_barcode == '1') checked @endif
                                id="generate_barcode" name="generate_barcode" type="checkbox"
                                class="form-control-custom">
