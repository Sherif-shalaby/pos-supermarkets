                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {!! Form::text('start_time', request()->start_time, ['class' => 'form-control time_picker
                            sale_filter']) !!}
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    {{-- <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('profit_type', ['purchase_price' => __('lang.purchase_price'), 'final_cost'
                            => __('lang.final_cost')], request()->profit_type, ['class' =>
                            'form-control', 'placeholder' => __('lang.all'),'data-live-search'=>"true"]) !!}
                        </div>
                    </div> --}}
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('payment_type', $wages_payment_types, null, ['class' => 'form-control',
