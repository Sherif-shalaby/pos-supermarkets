                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('expense_beneficiary_id', [], null, ['class' => 'form-control
                                        selectpicker', 'data-live-search' => 'true', 'id' => 'expense_beneficiary_id',
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        __('lang.pos'), 'store' => __('lang.store'), 'safe' => __('lang.safe')], 'user',
