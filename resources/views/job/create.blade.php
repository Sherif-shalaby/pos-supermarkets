...
<div class="modal-dialog  modal-lg" role="document">
    <div class="modal-content">
        <div
            ...
            <h5 class="modal-title  px-2 position-relative" id="add_job">@lang('lang.add_job')
        ...
        <div class="modal-footer d-flex justify-content-center align-content-center gap-3">
            ...
            <button type="submit" class="btn btn-main py-1 col-md-3">@lang('lang.save')</button>
            <button type="button" class="btn btn-danger py-1 col-md-3" data-dismiss="modal">Close</button>
        </div>
        {!! Form::close() !!}
    </div>
</div>
