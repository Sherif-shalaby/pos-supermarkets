                        ...
                        <div class="row locale_dir">
                            <div class="col-md-4">
                                ...
                                <div class="input-group my-group">
                                    ...
                                    'data-live-search' => 'true', 'style' => 'width: 80%', 'id' => 'customer_id',
                            ...
                            <div class="col-md-3">
                                <label class="locale_label mb-1 " style="margin-top: 36px;">@lang('lang.customer_type'):
                ...
                <div class="row locale_dir">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            form-control', 'data-live-search' => 'true', 'placeholder' => __('lang.please_select'),
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger col-6" id="send-btn">@lang('lang.send')</button>
