            ...
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    ...
                    <div
                        ...
                        <div class="form-group">
                            {!! Form::label('created_by', __('lang.chef'), ['class' =>"locale_label mb-1
                            field_required"]) !!}
                    ...
                    <div class="col-md-3">
                        {!! Form::label('date_and_time', __('lang.date_and_time'), ['class' =>"locale_label mb-1"]) !!}
                ...
                <table class="table table-bordered" id="consumption_table">
                    <thead>
                        <tr>
                            ...
                            {{-- <td style="width: 20%;"><button type="button" class="btn btn-xs btn-success add_row"><i
