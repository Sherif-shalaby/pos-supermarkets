        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="locale_label mb-1 field_required" for="tax_id">@lang('lang.tax')</label>
            ...
            <div class="card-body py-2 px-4">
                <div id="payment_rows" class="col-md-12">
                    <div class="row payment_row">
                        ...
                        <div class="col-md-3 mt-1 payment_fields hide">
                            <label class="locale_label mb-1 field_required">@lang('lang.received_amount') </label>
                            <input type="text" name="payments[0][amount]" class="form-control numkey received_amount"
                                required id="amount" step="any">
                        </div>
                        <div class="col-md-3 mt-1 payment_fields hide">
                            <label class="locale_label mb-1 field_required">@lang('lang.paying_amount') </label>
                        ...
                        <div class="form-group col-md-12 cheque_field payment_fields hide">
                            <label class="locale_label mb-1 field_required">@lang('lang.cheque_number') </label>
                            <input type="text" name="payments[0][cheque_number]" class="form-control">
                        </div>
                        <div class="form-group col-md-12 gift_card_field hide">
                            <div class="col-md-12">
                                <label class="locale_label mb-1 field_required">@lang('lang.gift_card_number') </label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="locale_label mb-1 "><b>@lang('lang.current_balance')</b> </label>
                                ...
                                <div class="col-md-4">
                                    <label class="locale_label mb-1 ">@lang('lang.enter_amount_to_be_used') </label>
                                    <input type="text" name="payments[0][amount_to_be_used]" id="amount_to_be_used"
                                        class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="locale_label mb-1 ">@lang('lang.remaining_balance') </label>
                                    <input type="text" name="payments[0][remaining_balance]" id="remaining_balance"
                                        class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="locale_label mb-1 "><b>@lang('lang.final_total')</b> </label>
                                </div>
                                <div class="col-md-4">
