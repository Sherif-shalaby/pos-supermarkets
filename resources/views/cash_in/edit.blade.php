<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action('CashInController@update', $cash_in->id),
            'method' => 'put',
            'id' => 'add_cash_in_form',
            'files' => true,
        ]) !!}
        ...
        <div
            ...
            <h5 class="modal-title px-2 position-relative d-flex align-items-center" style="gap: 5px;">@lang('lang.add_cash_in')
            </h5>
                ...
                <div class="row @if (app()->isLocale('ar')) flex-row-reverse @else flex-row @endif">
                    ...
                    <div class="col-md-6 px-5">
                        <div class="form-group">
                            ...
                            {!! Form::text('amount', @num_format($cash_in->amount), [
                    ...
                    <div class="col-md-6 px-5">
                        <div class="form-group">
                            ...
                            {!! Form::select('source_id', $users, $cash_in->source_id, [
                    ...
                    <div class="col-md-12 px-5">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('notes', $cash_in->notes, [
                                'class' => 'form-control modal-input app()->isLocale("ar") ? text-end : text-start',
