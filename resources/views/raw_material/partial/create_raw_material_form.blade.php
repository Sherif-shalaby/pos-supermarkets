        ...
        <div class="row locale_dir">
            ...
            <div class="col-md-4">
                <div class="form-group supplier_div">
                    {!! Form::label('supplier_id', __('lang.supplier'), ['class' =>"locale_label mb-1 field_required"])
                    !!}
                    <div class="input-group my-group">
...
<div class="card mt-1 mb-0">
    <div class="card-body py-2 px-4">
        <div class="row locale_dir">
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-6 hide">
                        <div class="form-group">
                            {!! Form::label('alert_quantity_unit_id', __('lang.unit'), ['class' =>"locale_label mb-1"])
                            !!}
            ...
            <div class="col-md-4">
                <div class="form-group">
                    {!! Form::label('purchase_price', __('lang.cost') , ['class' =>"locale_label mb-1
                    field_required"]) !!}
