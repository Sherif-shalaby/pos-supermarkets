                ...
                <div class="row locale_dir">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::label('paying_currency_id', __('lang.paying_currency') , ['class' =>"locale_label
                            mb-1"]) !!}
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                ...
                <div class="row locale_dir">
                    ...
                    <div class="col-md-6">
                        <a class="btn btn-block btn-primary" href="{{ asset('sample_files/add_stock_import.xlsx') }}"><i
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('other_expenses', __('lang.other_expenses'), ['class' =>"locale_label
                            mb-1"]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('other_payments', __('lang.other_payments'), ['class' =>"locale_label
                            mb-1"]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('payment_status', __('lang.payment_status') , ['class' =>"locale_label mb-1
                            field_required"]) !!}
                    ...
                    <div class="col-md-3 due_amount_div hide">
                        <label for="due_amount" class="locale_label mb-1 ">@lang('lang.due') <span
                                class="due_amount_span">{{
