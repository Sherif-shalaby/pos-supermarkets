    ...
    <div class="row locale_dir">
        <div class="col-md-3 payment_fields hide">
            <div class="form-group">
                ...
                {!! Form::text('amount',
                !empty($transaction_payment)&&!empty($transaction_payment->amount)?$transaction_payment->amount:(!empty($payment)
        ...
        <div class="col-md-3 not_cash_fields hide">
            <div class="form-group">
                {!! Form::label('bank_deposit_date', __('lang.bank_deposit_date'), ['class' =>"locale_label
                mb-1 field_required"]) !!}
