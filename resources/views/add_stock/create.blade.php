...
<section class="forms py-2">
    <div class="container-fluid px-2">
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row ">
                    ...
                    <div class="col-md-3">
                        <div class="i-checks">
                            <input @if (isset($clear_all_input_stock_form) && $clear_all_input_stock_form=='1' ) checked
                                @endif id="clear_all_input_form" name="clear_all_input_form" type="checkbox"
                ...
                <div class="row locale_dir">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="d-flex flex-row-reverse" style="gap: 6px">
                                {!! Form::label('po_no', __('lang.po_no'), ['class' =>"locale_label mb-1 "]) !!} <i
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            =>
                            __('lang.partially_received')],!empty($recent_stock)&&!empty($recent_stock->status)?$recent_stock->status:
                            'Please Select', ['class' => 'selectpicker form-control', 'data-live-search' =>
                            'true', 'required', 'style' => 'width: 80%', 'placeholder' =>
                            __('lang.please_select')]) !!}
                        </div>
                    </div>
                    <div class="col-md-3">
                        {!! Form::label('transaction_date', __('lang.date_and_time'), ['class' =>"locale_label mb-1 "])
                        !!}
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row locale_dir flex_center">
                    <div class="col-md-10">
                    ...
                    <div class="col-md-2 flex_center">
                        @include(
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="col-md-12 text-center">
                    <h4>@lang('lang.items_count'): <span class="items_count_span" style="margin-right: 15px;">0</span>
        ...
        <div class="card mt-1 mb-0">
            <div class="card-body py-2 px-4">
                <div class="row locale_dir">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('invoice_no', __('lang.invoice_no'), [ 'class' =>"locale_label mb-1 "]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('other_expenses', __('lang.other_expenses'), [ 'class' =>"locale_label mb-1
                            "]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('discount_amount', __('lang.discount'), [ 'class' =>"locale_label mb-1 "])
                            !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('other_payments', __('lang.other_payments'), [ 'class' =>"locale_label mb-1
                            "]) !!}
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('source_type', __('lang.source_type'), [ 'class' =>"locale_label mb-1
                            field_required"]) !!}
                            {!! Form::select('source_type', ['user' => __('lang.user'), 'pos' => __('lang.pos'),
                            'store' => __('lang.store'), 'safe' => __('lang.safe')],
                            !empty($recent_stock)&&!empty($recent_stock->source_type)?$recent_stock->source_type:'Please
                            Select', ['class' => 'selectpicker form-control', 'data-live-search' => 'true',
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('source_of_payment', __('lang.source_of_payment'), [ 'class' =>"locale_label
                            mb-1 field_required"]) !!}

                            {!! Form::select('source_id',
                            $users,!empty($recent_stock)&&!empty($recent_stock->source_id)?$recent_stock->source_id:null,
                    ...
                    <div class="col-md-3 due_amount_div hide">
                        <label class="locale_label mb-1 " for="due_amount" style="margin-top: 25px;">@lang('lang.due')
                            <span class="due_amount_span">{{
                                @num_format(0) }}</span></label>
                    </div>
                    ...
                    <div class="col-md-3 due_fields hide">
                        <div class="form-group">
                            ...
                            {!!
                            Form::text('due_date',!empty($transaction_payment)&&!empty($transaction_payment->due_date)?@format_date($transaction_payment->due_date):(!empty($payment)
                    ...
                    <div class="col-md-3 due_fields hide">
                        <div class="form-group">
                            ...
                            {!! Form::text('notify_before_days',
                            !empty($transaction_payment)&&!empty($transaction_payment->notify_before_days)?$transaction_payment->notify_before_days:(!empty($payment)
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!!
                            Form::textarea('notes',!empty($recent_stock)&&!empty($recent_stock->notes)?$recent_stock->notes:null,
