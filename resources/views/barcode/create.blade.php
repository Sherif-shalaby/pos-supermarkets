                ...
                <div class="row locale_dir">
                    ...
                    <div class="col-md-8">
                        <div class="search-box input-group">
                            <button type="button" class="btn btn-secondary btn-lg"><i class="fa fa-search"></i></button>
                    ...
                    <div class="row locale_dir">
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.product_name')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.price')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.size')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.color')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.grade')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.unit')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>@lang('lang.size')
                                                @lang('lang.variations')</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mt-1 mb-0">
                                <div class="card-body py-2 px-4 flex_center">
                                    <div class="i-checks toggle-pill-color">
                                        ...
                                        <span><strong>{{ App\Models\System::getProperty('site_title')
                                                }}</strong></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label class="locale_label mb-1" for="">@lang('lang.text')</label>
