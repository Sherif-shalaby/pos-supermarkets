                    ...
                    <div class="row locale_dir">
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('store_id', __('lang.store'), ['class' =>"locale_label
                                mb-1"]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('user_id', __('lang.cashier'), ['class' =>"locale_label
                                mb-1"]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('new_balance', __('lang.new_balance'), ['class'
                                =>"locale_label
                                mb-1"]) !!}
