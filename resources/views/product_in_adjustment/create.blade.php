                    ...
                    <div class="row locale_dir">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('active', [0 => __('lang.no'), 1 => __('lang.yes')],
                                request()->active,
                                [
                                'class' => 'form-control filter_product
                                selectpicker',
                        ...
                        <div class="col-md-3">
                            <div class="form-group flex_center flex-column">
                                {{-- <label>
            ...
            <div class="card mt-1 mb-1">
                <div class="card-body py-2 px-4">
                    <div style="text-align: center;">
                        <p style="color: rgb(219, 76, 76)" class="mb-0">@lang('lang.check_purchase_price_please')</p>
                    </div>
                </div>
            </div>
